...
export const challengesData: challenge[] = [
    ...
    {
        title: "The Community",
        accordianTitle: "feels frustrated",
        blurb: "with the dearth of up-to-date information, having to wait in haphazard lines, and being denied a personalized experience at their local pantries. In the end, they're put off by the undignified experience they face.",
